...
(1, 1, 'login', 'SUCCESS', 'accounts/login', 'username=azziwa@gmail.com|device=Other|browser=Firefox', '127.0.0.1', '2015-11-04 23:15:06'),
(2, 1, 'login', 'SUCCESS', 'accounts/login', 'username=azziwa@gmail.com|device=Other|browser=Firefox', '127.0.0.1', '2015-11-04 23:16:46'),
(3, 0, '', 'success', 'accounts/logout', '', '127.0.0.1', '2015-11-04 23:20:25'),
(4, 0, 'user_logout', 'success', 'accounts/logout', 'userid=|email=', '127.0.0.1', '2015-11-04 23:22:53'),
(5, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-04 23:23:11'),
(6, 1, 'user_logout', 'success', 'accounts/logout', 'userid=1|email=admin@pss.gov', '127.0.0.1', '2015-11-04 23:23:21'),
(7, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:25:31'),
(8, 1, 'user_logout', 'success', 'accounts/logout', 'userid=1|email=admin@pss.gov', '127.0.0.1', '2015-11-05 07:25:46'),
(9, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:37:19'),
(10, 1, 'user_logout', 'success', 'accounts/logout', 'userid=1|email=admin@pss.gov', '127.0.0.1', '2015-11-05 07:37:45'),
(11, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:37:55'),
(12, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:39:09'),
(13, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:39:39'),
(14, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:41:14'),
(15, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:42:06'),
(16, 1, 'user_logout', 'success', 'accounts/logout', 'userid=1|email=admin@pss.gov', '127.0.0.1', '2015-11-05 07:45:49'),
(17, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 07:46:34'),
(18, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-05 22:30:05'),
(19, 1, 'user_logout', 'success', 'accounts/logout', 'userid=1|email=admin@pss.gov', '127.0.0.1', '2015-11-05 22:30:33'),
(20, 0, 'user_logout', 'success', 'accounts/logout', 'userid=|email=', '127.0.0.1', '2015-11-05 23:05:02'),
(21, 1, 'login', 'SUCCESS', 'accounts/login', 'username=admin@pss.gov|device=Other|browser=Firefox', '127.0.0.1', '2015-11-06 20:53:13'),
(22, 1, 'user_logout', 'success', 'accounts/logout', 'userid=1|email=admin@pss.gov', '127.0.0.1', '2015-11-06 20:53:17'),
(23, 0, 'email__message_sent', 'SUCCESS', 'pages/contact_us', 'message=Website Message Sent From Almond|sent_to=|sent_by= ()', '127.0.0.1', '2015-11-10 09:15:17'),
(24, 0, 'email__message_sent', 'SUCCESS', 'pages/contact_us', 'message=Website Message Sent From Almond|sent_to=|sent_by=noreply@rssprocurement.org (Public Procurement Portal)', '127.0.0.1', '2015-11-10 09:16:41');
