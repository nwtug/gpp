...
<<<<<<< HEAD
<tr><td><input type='text' id='phrase' name='phrase' placeholder='Name Search Phrase' data-final='phrase' value='<?php echo $this->native_session->get('secure__phrase');?>' style='width:100%;'/></td></tr>
=======
