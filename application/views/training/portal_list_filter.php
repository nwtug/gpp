...
<tr>
  <td><input type='text' id='dateto' name='dateto' data-final='dateto' class='calendar clickactivated' onclick='setDatePicker()' placeholder='To' value='<?php echo $this->native_session->get('to__date');?>' style='width:100%;'/><input type='hidden' id='parentarea' name='parentarea' data-final='parentarea' value='activities_portal_home' style='width:100%;'/></td></tr>
...
<?php echo minify_js('resources__activities_portal_list_filter', array('jquery-2.1.1.min.js', 'jquery-ui.js', 'jquery.form.js', 'jquery.datepick.js', 'pss.js', 'pss.shadowbox.js', 'pss.fileform.js','pss.datepicker.js', 'pss.pagination.js'));?>
