...
echo "<table>
<tr><th style='width:1%;'>&nbsp;</th><th>Name</th><th>Contact</th><th>Tax ID</th><th>Category/Ministry</th><th>ROP #</th><th>Country</th><th>Address</th><th>Status</th><th>Registered</th><th>Joined</th></tr>";
	foreach($list AS $row) {
		$i++;
		echo "<tr> 
