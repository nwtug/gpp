...
<div class='right-div row-divs small-padding'>
	<div class='btn h5' data-rel='users/settings/view/Y'><?php echo $this->native_session->get('__first_name').' '.$this->native_session->get('__last_name').' ['.$this->native_session->get('__organization_name').']'?></div>
