...
<<<<<<< HEAD
    ...
    <div class='btn<?php if($__page == 'contracts') echo " active";?>' data-rel='procurement_plans/manage'>Contracts</div>
...
=======
  	<div class='btn<?php if($__page == 'my_dashboard') echo " active";?>' data-rel='accounts/provider_dashboard'>My Dashboard</div>
    <div class='btn<?php if($__page == 'bids') echo " active";?>' data-rel='bids/my_list'>Bids</div>
