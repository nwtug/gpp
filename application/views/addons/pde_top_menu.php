<tr>
  ...
  <div class='left-div top-divs'>
  	<div class='btn<?php if($__page == 'my_dashboard') echo " active";?>'  data-rel='accounts/pde_dashboard'>My Dashboard</div>
  ...
  <div class='right-div'><div class='trigger-search shadowbox closable' data-url='<?php echo base_url().'pages/system_search/t/secure/area/pde';?>'>&nbsp;</div></div></td>
  <td class='grey-menu-bg'>&nbsp;</td>
</tr>
