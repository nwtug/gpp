...
<tr><td style="padding-bottom:0px;"><button type="button" id="sendpassword" name="sendpassword" class="btn grey submitmicrobtn" style="width:100%;">Send Recovery Link</button><input type="hidden" name="resultsdiv" id="resultsdiv" value="forgotmsgdiv">
    <input type="hidden" name="action" id="action" value="<?php echo base_url();?>account/forgot"></td></tr>
</table>
</form>
</div>
