...
if($type == 'provider'){
echo "<tr><td class='label'>Tax ID</td><td>".$organization['tax_id']."</td></tr>
<tr><td class='label'>Registration Number</td><td>".(!empty($organization['registration_number'])? $organization['registration_number']: 'NOT CERTIFIED')."</td></tr>";
}

echo "<tr><td class='label'>Administrator</td><td>".$organization['owner']."</td></tr>
...
echo "<tr><td class='label'>Status</td><td>".strtoupper($organization['status'])."</td></tr>
