...
<input type='hidden' name='provider_id' id='provider_id' data-final='provider_id' value='<?php echo $this->native_session->get('tender__provider_id');?>' /><input type='hidden' id='parentarea' name='parentarea' data-final='parentarea' value='contract_awards_details' style='width:100%;'/></td></tr>
