...
<tr><td><input type='text' id='phrase' name='phrase' placeholder='Tender Notice Search Phrase' data-final='phrase' value='<?php echo $this->native_session->get('bid__phrase');?>' style='width:100%;'/></td></tr>
