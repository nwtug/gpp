...
<tr><td colspan="2"><button type="button" id="applyfilterbtn" name="applyfilterbtn" class="btn blue" onClick="applyFilter('bestevaluatedbidders')" style="width:100%;">Apply Filter</button>
