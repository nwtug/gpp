...
<input type='hidden' name='pde_id' id='pde_id' data-final='pde_id' value='<?php echo $this->native_session->get('document__pde_id');?>' />

<?php 
if(!($this->native_session->get('__user_type') && $this->native_session->get('__user_type') == 'admin')){
	echo "<input type='hidden'  id='search__documentstatus'  name='search__documentstatus' data-final='status' value='published' />";
}
if(!empty($t)){ 
