...
<tr>
  <td><input type='text' id='date' name='date' data-final='date' class='calendar clickactivated' onclick='setDatePicker()' placeholder='Posted Before' value='<?php echo $this->native_session->get('dateadded__date');?>' style='width:100%;'/><input type='hidden' id='parentarea' name='parentarea' data-final='parentarea' value='document_portal_home' style='width:100%;'/></td></tr>
